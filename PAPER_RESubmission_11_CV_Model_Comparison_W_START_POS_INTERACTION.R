...
for (year in 2014:2020){
  ...
  save(ordnet.fits, file=paste0("RESUBMISSION_CFB_YEAR=", year, "_W_START_POS_INTERACTION_ORDNET_ordnetCV.objects.Robj"))
  save(CV.results.with.complem, file = paste0("CFB_YEAR=", year, "_W_START_POS_INTERACTION_CV.results.with.complem.Robj"))
  save(CV.results.with.complem.prop, file = paste0("CFB_YEAR=", year, "_W_START_POS_INTERACTION_CV.results.with.complem.prop.Robj"))
  save(CV.results.no.complem, file = paste0("CFB_YEAR=", year, "_W_START_POS_INTERACTION_CV.results.no.complem.Robj"))
  save(CV.results.nothing, file = paste0("CFB_YEAR=", year, "_W_START_POS_INTERACTION_CV.results.nothing.Robj"))
  save(CV.results.only.complem, file = paste0("CFB_YEAR=", year, "_W_START_POS_INTERACTION_CV.results.only.complem.Robj"))
