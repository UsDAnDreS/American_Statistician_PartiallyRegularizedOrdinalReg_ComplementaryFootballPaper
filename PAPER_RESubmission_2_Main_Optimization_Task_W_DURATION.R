...
##  save(ordnet.obj.list, file= paste0("MULT_REP_NONPARALLEL_ORDNET/RESUBMISSION/CFB_W_DURATION_year=", as.character(year), ifelse(NO_TAKEAWAYS, "_NO_TAKEAWAYS",""), "_stand=", stand, "_nlambdas=", n.lambdas, "_nfolds=", n.folds, "_nreps=", n.CV.reps, "_TUNE_OBJECTS.RData"))
##  save(lambda.1se.est, file= paste0("MULT_REP_NONPARALLEL_ORDNET/RESUBMISSION/CFB_W_DURATION_year=", as.character(year), ifelse(NO_TAKEAWAYS, "_NO_TAKEAWAYS",""), "_stand=", stand, "_nlambdas=", n.lambdas, "_nfolds=", n.folds, "_nreps=", n.CV.reps, "_lambda.1se.est.RData"))
## 
...
for (year in 2014:2020){
  ...
  # #
  # # pbp_by_drive$drive_time_seconds_start
  # # pbp_by_drive$drive_time_minutes_start
  # # (5-pbp_by_drive$drive_qtr_start)*900  - (pbp_by_drive$drive_time_minutes_start)*60 - (60-pbp_by_drive$drive_time_seconds_start)
  # 
  # pbp_by_drive$drive_TimeSecs_elapsed_start <-  (pbp_by_drive$drive_qtr_start-1)*900 + (15-pbp_by_drive$drive_time_minutes_start)*60 - pbp_by_drive$drive_time_seconds_start
  # 
  ...
  # pbp_by_drive$drive_duration_seconds[our.ind] <- lead(pbp_by_drive$drive_TimeSecs_elapsed_start)[our.ind] - pbp_by_drive$drive_TimeSecs_elapsed_start[our.ind]
  # 
  # # print(summary(pbp_by_drive$drive_duration_seconds))
  # 
  ...
  # print(tail(sort(pbp_by_drive$drive_duration_seconds, dec=T)))
