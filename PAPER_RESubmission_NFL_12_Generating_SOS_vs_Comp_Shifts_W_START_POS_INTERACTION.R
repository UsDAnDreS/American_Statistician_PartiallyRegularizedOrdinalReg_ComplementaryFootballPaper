...
save(projected.points.intercept, file= paste0("SOS_VS_COMP_ADJ_SHIFT_PLOTS_RESUBMISSION_NFL_W_START_POS_ORDNET_projected.points.intercept.RData"))
save(projected.by.game, file= paste0("SOS_VS_COMP_ADJ_SHIFT_PLOTS_RESUBMISSION_NFL_W_START_POS_ORDNET_projected.by.game.RData"))
# save(ordnet.fits, file=paste0("SOS_VS_COMP_ADJ_SHIFT_PLOTS_RESUBMISSION_NFL_W_START_POS_ORDNET_ordnet.fits.RData"))
...
load(file= paste0("SOS_VS_COMP_ADJ_SHIFT_PLOTS_RESUBMISSION_NFL_W_START_POS_ORDNET_projected.points.intercept.RData"))
load(file=paste0("SOS_VS_COMP_ADJ_SHIFT_PLOTS_RESUBMISSION_NFL_W_START_POS_ORDNET_projected.by.game.RData"))
...
SeasonLong.Shifts.NFL.df <- list(SOS=boot.df.SOS, complem = boot.df.complem)
save(SeasonLong.Shifts.NFL.df, file=paste0("W_START_POS_INTERACTION_SeasonLong.Shifts.NFL.",side, ".df.Robj"))
...
SingleGame.Shifts.NFL.df <- list(SOS=boot.df.SOS, complem = boot.df.complem)
save(SingleGame.Shifts.NFL.df, file=paste0("W_START_POS_INTERACTION_SingleGame.Shifts.NFL.",side, ".df.Robj"))
