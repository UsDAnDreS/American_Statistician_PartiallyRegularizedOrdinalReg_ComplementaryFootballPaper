...
## NFL
##
## Reproducing the selection stability Figure 1(a) from the main paper,
...
for (year in year.range){
  ...
  load(paste0("MULT_REP_NONPARALLEL_ORDNET/RESUBMISSION_CLEANED/NFL_W_DURATION_year=", as.character(year), ifelse(NO_TAKEAWAYS, "_NO_TAKEAWAYS",""), ifelse(stand, "_stand=TRUE", "_stand=FALSE"), "_nlambdas=", n.lambdas, "_nfolds=", n.folds, "_nreps=", n.CV.reps, "_lambda.1se.est.RData"))
